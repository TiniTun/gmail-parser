...
from config_cli import BUCKET_NAME, GCS_PREFIX, TOKEN_FILE, CLIENT_FILE, SENDER, SUBJECT, GOOGLE_APPLICATION_CREDENTIALS
...
def generate_signed_url(blob, expiration_minutes=60):
    сredentials = service_account.Credentials.from_service_account_file(GOOGLE_APPLICATION_CREDENTIALS)
